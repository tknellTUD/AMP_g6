!/bin/bash
SBATCH --job-name="centerpoint_altered_dropout"
...
srun python -u common_src/tools/train.py exp_id=centerpoint_baseline_db_try_slurm batch_size=4 num_workers=2 epochs=6
